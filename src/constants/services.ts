...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    color: '#F59E0B',
    features: [
      'هنتابع معاك كل الخدمات الي بنقدمها اول بأول',
      'هنبعتلك رساله ونكلمك هاتفيا كلما جد جديد',
      'هنقدملك علي كل الخدمات من خلالنا',
      'هيكونلك خصم علي جميع الخدمات بعد الاشتراك في خدمة العميل المميز',
      'هتكون اولوية اوي بالنسبالنا في الاهتمام و الرد علي استفساراتك ♥',
      'تشمل الخدمات: شحن الكتب - دفع المصروفات - تقديم التحول الرقمي - شحن ملازم الشرح - عمل التكليفات و الشيتات - حجز ملازم المراجعة - شحن ملازم التحول الرقمي - عمل اثبات قيد - عمل افادة - سحب الشهادة و الملف'
    ],
    fields: [
